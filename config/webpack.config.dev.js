...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.LoaderOptionsPlugin({
            ...
            options: {
                sassLoader: {
                    includePaths: [path.resolve(__dirname, 'src', 'scss'), path.resolve(__dirname, 'src', 'styles', 'scss')],
                },
                lessLoader: {
                    includePaths: [path.resolve(__dirname, 'src', 'less'), path.resolve(__dirname, 'src', 'styles', 'less')],
                },
                context: '/',
